...
(function () {
  ...
  var T = {
    en: {
      ...
      "common.comingSoonAppStore": "Coming soon to the App Store",
      ...
      "hero.badgeSmall": "Coming soon to the",
      "hero.seeFeatures": "See features",
      "hero.note": "7-day free trial · No account needed",

      // index — phone mockup (decorative)
      "mock.greeting": "Good morning",
      "mock.today": "Today",
      "mock.t1.name": "Call the dentist",
      "mock.t1.time": "9:00 AM",
      "mock.health": "Health",
      "mock.t2.name": "Pick up groceries",
      "mock.t2.time": "5:30 PM",
      "mock.errands": "Errands",
      "mock.t3.name": "Team standup",
      "mock.t3.time": "Done · 10:00 AM",
      "mock.t4.name": "Water the plants",
      "mock.t4.time": "7:00 PM",
      "mock.home": "Home",
      ...
      "pricing.thenLine": "then <span class=\"todo\">[TODO: price / month]</span>, billed monthly",
    ...
    zh: {
      ...
      "common.comingSoonAppStore": "即将上架 App Store",
      ...
      "mock.today": "今天",
      "mock.t1.name": "给牙医打电话",
      "mock.t1.time": "上午 9:00",
      "mock.health": "健康",
      "mock.t2.name": "买日用品",
      "mock.t2.time": "下午 5:30",
      "mock.errands": "杂务",
      "mock.t3.name": "团队站会",
      "mock.t3.time": "已完成 · 上午 10:00",
      "mock.t4.name": "给植物浇水",
      "mock.t4.time": "下午 7:00",
      "mock.home": "家庭",
      ...
      "pricing.thenLine": "之后 <span class=\"todo\">[TODO: price / month]</span>，按月计费",
      "pricing.cta": "开始免费试用",
